export const DATA = {
	...
	TECH_GUIDE_LIST: [
		...
		},
		{
			...
			ul: ["Рассмотрим назначение Redux и проблемы которые он решает", "Разберемся как подключать Redux в React-приложении. Разберем основные концепции", "Работаем с синхронными экшенами на примере конкретных кейсов", "Асинхронные экшены в Redux", "Типизация Redux с помощью Typescript", "Рассмотрим альтернативные подходы при работе с глобальным состоянием Приложения"],
			src: "./icons/langs/redux.svg",
		},
	],
	FORM_LIST: [
