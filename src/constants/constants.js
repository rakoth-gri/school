export const DATA = {
	...
	FAQ_LIST: [
		...
		},
		{
			...
			content:
				"Необходимо установить среду разработки <strong> <a href='https://code.visualstudio.com/download' style='color: var(--app-blue-color)'> Visual Studio Code </a> </strong> с официального сайта. Зарегистрировать новый <strong> <a href='https://accounts.google.com/v3/signin/identifier?dsh=S-1224258872%3A1685454936764904&authuser=0&continue=https%3A%2F%2Fwww.google.com%2F%3Fhl%3Dru&ec=GAlAmgQ&hl=ru&flowName=GlifWebSignIn&flowEntry=AddSession' style='color: var(--app-blue-color)'> Google Account </a> </strong> или использовать имеющийся.",
		},
		{
			id: "6",
		...
		{
			id: "7",
			title: "Могу ли я выбрать конкретный курс из представленных в <a href='#roadmap' style='color: var(--app-blue-color)'><strong> карте обучения </strong></a> ?",
			content:
	...
	TABS_LIST: [
		...
		},
		{
			...
			id: 1,
			content: ["Процесс обучения организован по принципу методической &quot;лестницы&quot;, т.о. движение идет от простых концептов к сложным. 90% времени занятия уделяется практической стороне (решение конкретных задач, разбор примеров, ссылки на документацию). Вначале, мы всегда будем обсуждать непонятные моменты и проверять ДЗ. Проходя определенную технологию, вы будите практиковаться, решая конкретную задачу учебного проекта", "Важно отметить, что весь код мы будем писать в <a href='https://code.visualstudio.com/download' style='color: var(--app-purple-color)'>IDE</a>, параллельно осваивая необходимые разработчику инструменты", "Некоторые разделы, по обоюдному согласованию, могут быть даны на самостоятельное обучение.", "В процессе обучения, будут использоваться бесплатные инструменты и технологии для комфортного освоения материала", "Продолжительность занятия выбирается на основе Ваших предпочтений, но мы не рекомендуем заниматься более 120 мин, т.к. качество усвоения материала может резко упасть"],			
		},
		{
			text: "Избирательные темы",
			id: 2,
			content: "Вы можете обозначить конкретную тему, в которой хотите разобраться, еще до занятия. Для этого просто отправьте мне сообщение в телеграм-чат или воспользуйтесь <a href='#callback' style='color: var(--app-purple-color); display: inline'> обратной связью на сайте </a>",			
		},
		{
			text: "Необходимые инструменты",
			id: 3,
			content: "Перед началом занятия Вам необходимо скачать IDE (редактор кода) и создать GOOGLE-аккаунт: все ссылки приведены в разделе <a href='#faq' style='color: var(--app-purple-color); display: inline'><strong>ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ</strong></a>",			
		},
		{
			text: "FIVTH BUTTON",
			id: 4,
